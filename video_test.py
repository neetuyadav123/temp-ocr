        ...
        if ret:
            ...
            if (s == 13): #enter to do realtime recognition
                ...
                if(orig != 0):
                    ...
                    cv2.putText(show, text1, (15, 30), cv2.FONT_HERSHEY_COMPLEX, 0.4, (0, 100, 200))
                    cv2.putText(show, text2, (15, 50), cv2.FONT_HERSHEY_COMPLEX, 0.4, (50, 20, 255))
                    cv2.rectangle(show, (s_x, s_y), (e_x, e_y), (0, 255, 0), 2)
                    cv2.putText(show, text, (15, 15), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (15, 0, 255), lineType=cv2.LINE_AA) 
